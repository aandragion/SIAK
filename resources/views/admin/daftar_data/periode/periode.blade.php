    ...
    <div class="wrapper">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped " id="dataTable" width="100%"
                                ...
                                <tbody id="myTable">
                                    ...
                                    @foreach ($d_periode as $item)
                                        <tr>
                                            <th>
                                                <center />{{ $i++ }}
                                            </th>
                                            <td>{{ $item->nama_periode }}</td>
                                            <td>{{ $item->smt_periode }}</td>
                                            <td>{{ $item->tgl_awal }}</td>
                                            <td>{{ $item->tgl_akhir }}</td>
                                            <td>
                                                <a href="{{ url('e-periode', $item->id_periode) }}"><i
                                                        class="fas fa-edit"></i> Edit</a> |
                                                <a href="{{ url('delete-periode', $item->id_periode) }}"><i
        ...
        <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
                <form action="{{ route('create-periode') }}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Input Periode</h4>
