    ...
    <div class="wrapper">
                                ...
                                <tbody id="myTable">
                                    ...
                                    @foreach ($d_matkul as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('e-matkul', $item->id_matkul) }}"><i
                                                        class="fas fa-edit"></i> Edit</a> |
                                                <a href="{{ url('delete-matkul', $item->id_matkul) }}"><i
        ...
        <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
                <form action="{{ route('create-matkul') }}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="kode_matkul" name="kode_matkul" class="form-control" value="{{old('kode_matkul')}}">
                            </div> 
                            <div class="form-group">
                                <label for="inputEstimatedBudget">Nama Mata Kuliah</label>
                                <input type="text" id="nama_matkul" name="nama_matkul" class="form-control" value="{{old('nama_matkul')}}">
                            </div>
                            <div class="form-group">
                                <label for="inputEstimatedBudget">SKS</label>
                                <input type="text" id="sks" name="sks" class="form-control" value="{{old('sks')}}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_programstudi" id="id_programstudi">
                                    ...
                                    @foreach ($d_prodi as $item)
                                        <option value="{{ $item->id_programstudi }}" @if (old('id_programstudi') == $item->id_programstudi) selected="selected" @endif>
                                            {{ $item->nama_jurusan }}
                                        </option>
                                    @endforeach
                                </select>
